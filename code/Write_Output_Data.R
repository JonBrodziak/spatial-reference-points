...
# results of assessment period calculations for SRP analyses 
# to the user-named OutputFile
...
print('_____________________________________________________________________________________________________')
print('SPATIAL REFERENCE POINT RESULTS')
print('_____________________________________________________________________________________________________')
#-----------------------------------------------------------------------------------------------
...
#-----------------------------------------------------------------------------------------------
print('(3.1.11) POPULATION NUMBERS AT AGE  ON JANUARY 1ST (Year Population Area Gender(1=Females))')
print('_____________________________________________________________________________________________________')
for (p in 1:NPopulation)
  for (d in 1:NArea)
    for (g in 1:NGender)
...
#-----------------------------------------------------------------------------------------------
# (3.1.12)  POPULATION MEAN LENGTHS AT AGE BY YEAR
#-----------------------------------------------------------------------------------------------
...
print('(3.1.12) POPULATION MEAN LENGTHS AT AGE DURING SPAWNING SEASON (Year Population Area Gender(1=Females))')
print('_____________________________________________________________________________________________________')
for (p in 1:NPopulation)
  for (d in 1:NArea)
    for (g in 1:NGender)
      for (y in 1:NYear)
      {
        print(c("Year=",y,"Population=",p,"Area=",d,"Gender=",g,"By Age",AssessmentMeanLengthSpawning[y,p,d,g,]))
      }
print('_____________________________________________________________________________________________________')

print('(3.1.12) POPULATION MEAN LENGTHS AT AGE IN FISHERY CATCH (Year Population Area Gender(1=Females))')
print('_____________________________________________________________________________________________________')
for (p in 1:NPopulation)
  for (d in 1:NArea)
    for (g in 1:NGender)
      for (y in 1:NYear)
      {
        print(c("Year=",y,"Population=",p,"Area=",d,"Gender=",g,"By Age",AssessmentMeanLengthCatch[y,p,d,g,]))
      }
print('_____________________________________________________________________________________________________')

print('(3.1.12) POPULATION MEAN LENGTHS AT AGE IN SURVEY CATCH (Year Population Area Gender(1=Females))')
print('_____________________________________________________________________________________________________')
for (p in 1:NPopulation)
  for (d in 1:NArea)
    for (g in 1:NGender)
      for (y in 1:NYear)
      {
        print(c("Year=",y,"Population=",p,"Area=",d,"Gender=",g,"By Age",AssessmentMeanLengthSurvey[y,p,d,g,]))
      }
print('_____________________________________________________________________________________________________')

#-----------------------------------------------------------------------------------------------
# (3.1.13)  POPULATION MEAN WEIGHTS AT AGE BY YEAR
#-----------------------------------------------------------------------------------------------
print('(3.1.13) POPULATION MEAN WEIGHTS AT AGE ON JANUARY 1ST (Year Population Area Gender(1=Females))')
print('_____________________________________________________________________________________________________')
for (p in 1:NPopulation)
  for (d in 1:NArea)
    for (g in 1:NGender)
...
print('(3.1.13) POPULATION MEAN WEIGHTS AT AGE DURING SPAWNING SEASON (Year Population Area Gender(1=Females))')
print('_____________________________________________________________________________________________________')
for (p in 1:NPopulation)
  for (d in 1:NArea)
    for (g in 1:NGender)
      for (y in 1:NYear)
      {
        print(c("Year=",y,"Population=",p,"Area=",d,"Gender=",g,"By Age",AssessmentMeanWeightSpawning[y,p,d,g,]))
      }
print('_____________________________________________________________________________________________________')

print('(3.1.13) POPULATION MEAN WEIGHTS AT AGE IN FISHERY CATCH (Year Population Area Gender(1=Females))')
print('_____________________________________________________________________________________________________')
for (p in 1:NPopulation)
  for (d in 1:NArea)
    for (g in 1:NGender)
      for (y in 1:NYear)
      {
        print(c("Year=",y,"Population=",p,"Area=",d,"Gender=",g,"By Age",AssessmentMeanWeightCatch[y,p,d,g,]))
      }
print('_____________________________________________________________________________________________________')

print('(3.1.13) POPULATION MEAN WEIGHTS AT AGE IN SURVEY CATCH (Year Population Area Gender(1=Females))')
print('_____________________________________________________________________________________________________')
for (p in 1:NPopulation)
  for (d in 1:NArea)
    for (g in 1:NGender)
...
print('_____________________________________________________________________________________________________')
print('Calculations are complete for MAS spatial reference point analyses')
print('_____________________________________________________________________________________________________')
