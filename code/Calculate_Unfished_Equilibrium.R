...
# the unfished equilibrium conditions for case study v2 
# of the MAS project.
...
print('Beginning calculations for MAS spatial reference point analyses ...')
print('_____________________________________________________________________________________________________')
print('_____________________________________________________________________________________________________')
...
UnfishedFinalIteration <- FinalIteration
